...
lm.k5.results_long <- reshape2::melt(lm.k5.results, id.vars = 'Fold')
...
```{r}
# reshape data for plotting
rf.k5.results_long <- reshape2::melt(rf.k5.results, id.vars = 'Fold')
...
```{r}
# reshape data for plotting
xgb.k5.results_long <- reshape2::melt(xgb.k5.results, id.vars = 'Fold')
